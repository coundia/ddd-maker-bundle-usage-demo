...
class FindByPhoneNumberWalletQueryControllerTest extends BaseWebTestCase
{
    use Factories;
    ...
    public function testListEntitiesWithPagination(): void
    {
        ...
        $response = $this->get('/api/v1/wallets/findbyphonenumber?phoneNumber='.$valuePhoneNumber);
