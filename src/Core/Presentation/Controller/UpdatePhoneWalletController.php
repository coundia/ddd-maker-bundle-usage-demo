...
#[Route('/api/v1/wallets/updatephone/', name: 'api_command_v1_wallet_updatephone', methods: ['POST'])]
#[OA\Post(
    path: '/api/v1/wallets/updatephone/',
...
class UpdatePhoneWalletController extends \App\Shared\Presentation\Controller\BaseController
{
    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $command = new \App\Core\Application\Command\UpdatePhoneWalletCommand(
